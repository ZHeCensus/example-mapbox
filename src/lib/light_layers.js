export const light_layers = {
  ...
  metadata: {
    ...
    "mapbox:groups": {
      ...
      "Base, built": { name: "Base, built", collapsed: true },
      ...
      "Place labels": { name: "Place labels", collapsed: true }
    },
  ...
  sprite:
    "mapbox://sprites/zhik/cjxnho9l02k381cqr4a3tr0py/aces8pgtge4ak91txbc2lccm8",
  ...
  layers: [
    {
      ...
      layout: {},
      paint: { "background-color": "hsl(210, 74%, 96%)" }
    },
    {
      id: "landcover",
      type: "fill",
    ...
    },
    {
      ...
      "source-layer": "water",
      layout: {},
      paint: { "fill-color": "hsl(210, 69%, 86%)" }
    },
    {
      ...
      layout: {},
      paint: { "fill-color": "hsl(210, 74%, 96%)" }
    },
    {
    ...
    },
    {
      ...
      layout: {},
      paint: {
        "fill-color": "hsl(210, 73%, 90%)",
        "fill-opacity": ["interpolate", ["linear"], ["zoom"], 15, 0, 16, 1],
        "fill-outline-color": "hsl(210, 71%, 87%)"
      }
    },
    {
    ...
    },
    {
      ...
      metadata: {
        "mapbox:featureComponent": "road-network",
        "mapbox:group": "Road network, labels"
      },
      source: "composite",
      "source-layer": "road",
      minzoom: 10,
      filter: [
        ...
        15,
        ["match", ["get", "class"], ["ferry", "golf", "path"], false, true]
      ],
      layout: {
        "text-size": [
          "interpolate",
      ...
      paint: {
        "text-color": "hsl(210, 75%, 49%)",
        "text-halo-color": "hsl(210, 74%, 100%)",
        "text-halo-width": 1,
        "text-halo-blur": 1
      }
    },
    {
      ...
      type: "symbol",
      metadata: {
        "mapbox:featureComponent": "natural-labels",
        "mapbox:group": "Natural labels"
      },
      source: "composite",
      ...
      paint: { "text-color": "hsl(210, 73%, 58%)" }
    },
    {
    ...
    },
    {
      ...
      metadata: {
        ...
        "mapbox:group": "Point of interest labels"
      },
      source: "composite",
    ...
    },
    {
      ...
      type: "symbol",
      metadata: {
        "mapbox:featureComponent": "transit-labels",
        "mapbox:group": "Transit labels"
      },
      source: "composite",
  ...
  created: "2019-07-03T17:02:23.131Z",
  id: "cjxnho9l02k381cqr4a3tr0py",
  modified: "2019-07-03T17:02:26.354Z",
  owner: "zhik",
  visibility: "private",
  draft: false
};
